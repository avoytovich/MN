...
const member: Member = {
  ...
  imageContent: {
    mediumImage:
      'http://s3.amazonaws.com/ogden_images/www.mauinews.com/images/2018/06/04055153/nf-Joseph-Bell-600x840.jpg'
  }
};
...
class CTest extends React.Component {
  render() {
    return (
      <div>
        <button onClick={() => this.props.open(member)}>
          Click to open modal
        </button>
      </div>
    );
