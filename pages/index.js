    ...
    return (
        ...
        <div className="landing-container">
          <Grid
            ...
            <Grid className="landing-top-container" >
              <div className="landing-wrapper">
                <h1 className="landing-top-title" >Build a stronger community in your organization</h1>
                <Grid container className="landing-top-btns-container">
                  <Button className="landing-white-btn">
                    Learn More
                  </Button>
            ...
            <Grid className="landing-introducing-container" >
              ...
              <div className="landing-wrapper">
                <Grid container wrap="nowrap" className="landing-introducing-top">
                  ...
                  <h1 className="landing-description">The easiest way for everyone to get to know each other</h1>
                </Grid>
                <Grid container wrap="nowrap" className="landing-introducing-bottom">
                  <Grid>
                    <Grid container direction="column">
                      <h1 className="landing-description">With our gamfied process, the members of your organizations now have a tool in their pocket to learn everyone’s name.</h1>
                      <Button className="landing-green-btn">
                        Request a demo
                      </Button>
                    </Grid>
                  </Grid>
                  <img className="landing-introducing-right-img" src={Right_Phone} />
                </Grid>
              </div>
            </Grid>
          ...
          <Grid className="landing-advantages-container" >
            <Grid className="landing-advantage">
              ...
              <p className="landing-advantage-description">of US Workers are not engaged at work</p>
            </Grid>
            <Grid className="landing-advantage">
              <h3 className="landing-advantage-title">87%</h3>
              <p className="landing-advantage-description">of engaged employees are less likely to leave their jobs</p>
                </Grid>
              <Grid className="landing-advantage">
                <h3 className="landing-advantage-title">2/3</h3>
                <p className="landing-advantage-description">Two of the top three reasons someone leaves an organizationis because they feel like they do not have a relationship with their boss or their co-workers. </p>
              </Grid>
            <Grid className="landing-advantage">
                <h3 className="landing-advantage-title">2.5x</h3>
                <p className="landing-advantage-description">Organizations with highly engaged employees have 2.5X the revenue than their competitors who do not.</p>
              </Grid>
            <Grid className="landing-advantage">
                <h3 className="landing-advantage-title">53%</h3>
                <p className="landing-advantage-description">53% of HR professionals say employee engagement rises when onboarding is improved</p>
              </Grid>
            </Grid>
                                                            
            <Grid className="landing-responses-container" >
              <div className="landing-responses-circle"></div>
            <div className="landing-wrapper">
              ...
              <div className="landing-responses-wrapper">
                <div className="landing-response">
                  <p className="landing-response-title">MetKnow helped all of our employees learn about each other when we merged offices. It made our first week in the new office run much more smoothly</p>
                  <Grid container>
                    <h3 className="landing-response-author">Paula A. Hub MidAmerica</h3>
                    <img src={HUB_Logo} className="landing-response-icon"/>
                    </Grid>
                    <div className="landing-response-triangle"/>
                  </div>  
                  <div className="landing-response">
                    <p className="landing-response-title">Our organization depends on attendees being able to identify and connect with the other attendees important to their agenda. MetKnow solved this problem in Sun Valley.”</p>
                <Grid container>
                  ...
                  <div className="landing-response">
                    <p className="landing-response-title">With MetKnow my organizations new members were integrated seamlessly into the flow of things. Strong relationships have helped us become a very efficient team.” </p>
              <Grid container>
                <h3 className="landing-response-author">Andrew N. Phi Delta Theta</h3>
      ...
      <Grid className="landing-contact-us-container" >
              <div className="landing-wrapper">
                ...
                <p className="landing-contact-us-text">Interested in signing your organization up? Contact us.</p>
                <div className="landing-contact-us-wrapper" >
                  <div className="landing-contact-us-item" >
                    ...
                    <p className="landing-contact-us-item-text" >911 Wa shington Ave Ste 633 St. Louis, MO 63101</p>
                  </div>
                  <div className="landing-contact-us-item" >
                    <MailIcon className="landing-contact-us-item-icon" />
                    <p className="landing-contact-us-item-text" >support@metknow.com</p>
                  </div>
                  <div className="landing-contact-us-item" >
                    <PhoneIcon className="landing-contact-us-item-icon"/>
                    <p className="landing-contact-us-item-text" >+1 (918) 289-4817</p>
                  </div>  
