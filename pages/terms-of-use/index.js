      ...
      <div className="terms-of-use-text-wrapper">
        ...
        <div className="content">
          <p>
            ...
            of an entity (“user” or “you”) and MetKnow LLC and its affiliated
            companies (collectively, “Company” or “we” or “us” or “our”),
            concerning your access to and use of the https://metknow.com website
            ...
            “Website”). The Website provides the following service: MetKnow
            generates flash cards and quizzes of members in an organization for
            their fellow members to review and quiz themselves on for the sake
            of learning each other's name. (“Company Services”). Supplemental
          ...
          <p>
            ...
            ALSO BY CONTINUING TO USE THE WEBSITE. IF YOU DO NOT AGREE TO ABIDE
            BY THIS AGREEMENT, OR TO MODIFICATIONS THAT COMPANY MAY MAKE TO THIS
          ...
          <h2>
            <i>Regarding Your Registration</i>
          </h2>
          ...
          <ul>
            ...
            <li>
              ...
              reside, or if a minor, you have received parental permission to
          ...
          <p>
            ...
            form and (b) maintain and promptly update registration data to keep
            it true, accurate, current and complete. If you provide any
            information that is untrue, inaccurate, not current or incomplete,
            or Company has reasonable grounds to suspect that such information
            is untrue, inaccurate, not current or incomplete, Company has the
          ...
          <p>
            ...
            select if we determine appropriate in our discretion, such as when
            the user name is obscene or otherwise objectionable or when a
            trademark owner complains about a username that does not closely
            relate to a user's actual name.
          </p>

          <h2>
            <i>Regarding Content You Provide</i>
          </h2>
          <p>
            The Website may invite you to chat or participate in blogs, message
            boards, online forums and other functionality and may provide you
            ...
            Company and/or to or via the Website, including, without limitation,
            text, writings, video, audio, photographs, graphics, comments,
            suggestions or personally identifiable information or other material
            (collectively "Contributions"). Any Contributions you transmit to
            Company will be treated as non-confidential and non-proprietary.
          ...
          <ul>
            ...
            <li>
              ...
              authorize Company and the Website users to use your Contributions
              as necessary to exercise the licenses granted by you under this
              Agreement;
            </li>
            <li>
              C. &nbsp; you have the written consent, release, and/or permission
              of each and every identifiable individual person in the
              ...
              Contribution in the manner contemplated by this Website;
            </li>
            <li>
              D. &nbsp; your Contribution is not obscene, lewd, lascivious,
              filthy, violent, harassing or otherwise objectionable (as
              determined by Company), libelous or slanderous, does not ridicule,
              mock, disparage, intimidate or abuse anyone, does not advocate the
            ...
            <li>
              ...
              solicits personal information from anyone under 18 or exploit
              people under the age of 18 in a sexual or violent manner, and does
          ...
          <p>
            By posting Contributions to any part of the Website, or making them
            accessible to the Website by linking your account to any of your
            ...
            channels. Such use and distribution license will apply to any form,
            ...
            and logos, personal and commercial images you provide. Company does
            not assert any ownership over your Contributions; rather, as between
            us and you, subject to the rights granted to us in this Agreement,
          ...
          <p>
            By uploading your Contributions to the Website, you hereby authorize
            Company to grant to each end user a personal, limited,
            non-transferable, perpetual, non-exclusive, royalty-free, fully-paid
          ...
          <h2>
            <i>Terms Applicable to Apple and Android Devices</i>
          </h2>
          <p>
            The following terms apply when you use a mobile application obtained
            from either the Apple Store or Google Play to access the Company
            Services. You acknowledge that this Agreement is concluded between
            you and Company only, and not with Apple Inc. or Google, Inc. (each
            an “App Distributor”), and Company, not an App Distributor, is
            solely responsible for the Company application and the content
            thereof. (1) SCOPE OF LICENSE: The license granted to you for the
            Company application is limited to a non-transferable license to use
            the Company application on a device that utilizes the Apple iOS or
          ...
          <p>
            ...
            (i) providing your Third Party Account login information through the
            Website; or (ii) allowing Company to access your Third Party
            ...
            information to Company and/or grant Company access to your Third
            Party Account (including, but not limited to, for use for the
            purposes described herein), without breach by you of any of the
            terms and conditions that govern your use of the applicable Third
            Party Account and without obligating Company to pay any fees or
            making Company subject to any usage limitations imposed by such
            third party service providers. By granting Company access to any
            Third Party Accounts, you understand that (i) Company may access,
            ...
            Network Content”) so that it is available on and through the Website
            via your account, including without limitation any friend lists, and
            (ii) Company may submit and receive additional information to your
            Third Party Account to the extent you are notified when you link
            your account with the Third Party Account. Depending on the Third
            Party Accounts you choose and subject to the privacy settings that
            ...
            available on and through your account on the Website. Please note
            ...
            Content may no longer be available on and through the Website. You
            ...
            AGREEMENT(S) WITH SUCH THIRD PARTY SERVICE PROVIDERS. Company makes
            no effort to review any Social Network Content for any purpose,
            including but not limited to, for accuracy, legality or
            non-infringement, and Company is not responsible for any Social
            Network Content. You acknowledge and agree that Company may access
            ...
            contacts who have also registered to use the Website. At your
            ...
            delete any information stored on Company’s servers that was obtained
          ...
          <p>
            ...
            ideas, feedback or other information about the Website or the
            Company Services ("Submissions") provided by you to Company are
            non-confidential and Company (as well as any designee of Company)
          ...
          <p>
            ...
            than that for which Company makes it available. The Website may not
            be used in connection with any commercial endeavors except those
            that are specifically endorsed or approved by Company. Prohibited
            activity includes, but is not limited to:
          </p>

          <ul>
            <li>
              A. &nbsp; attempting to bypass any measures of the Website
              designed to prevent or restrict access to the Website, or any
              portion of the Website
            </li>
            <li>
              B. &nbsp; attempting to impersonate another user or person or
              using the username of another user
            </li>
            <li>C. &nbsp; criminal or tortious activity</li>
            <li>
              D. &nbsp; deciphering, decompiling, disassembling or reverse
              engineering any of the software comprising or in any way making up
              a part of the Website
            </li>
            <li>
              E. &nbsp; deleting the copyright or other proprietary rights
              notice from any Website content
            </li>
            <li>
              F. &nbsp; engaging in any automated use of the system, such as
              using any data mining, robots or similar data gathering and
              extraction tools
            </li>
            <li>
            ...
            <li>
              H. &nbsp; harassing, annoying, intimidating or threatening any
              Company employees or agents engaged in providing any portion of
              the Company Services to you
            </li>
            <li>
              I. &nbsp; interfering with, disrupting, or creating an undue
              burden on the Website or the networks or services connected to the
              Website
            </li>
            <li>
            ...
            <li>
              M. &nbsp; tricking, defrauding or misleading Company and other
              users, especially in any attempt to learn sensitive account
              information such as passwords
            </li>
            <li>
              N. &nbsp; using any information obtained from the Website in order
              to harass, abuse, or harm another person
            </li>
            <li>
              O. &nbsp; using the Company Services as part of any effort to
              compete with Company or to provide services as a service bureau
            </li>
            <li>
              P. &nbsp; using the Website in a manner inconsistent with any and
          ...
          <p>
            ...
            licensed to Company, and are subject to copyright and other
          ...
          <p>
            ...
            any portion of the Company Content to which you have properly gained
            access solely for your personal, non-commercial use. Company
            reserves all rights not expressly granted to you in and to the
          ...
          <p>
            ...
            for any Third Party Websites accessed through the Website or any
            Third Party Content posted on, available through or installed from
            the Website, including the content, accuracy, offensiveness,
            ...
            Website and access the Third Party Websites or to use or install any
            Third Party Content, you do so at your own risk and you should be
            aware that our terms and policies no longer govern. You should
            ...
            Website or relating to any applications you use or install from the
            Website. Any purchases you make through Third Party Websites will be
            through other websites and from other companies, and Company takes
          ...
          <ul>
            ...
            <li>
              ...
              portion thereof that may violate this Agreement or any Company
              policy;
            </li>
            <li>
            ...
            <li>
              E. &nbsp; otherwise manage the Website in a manner designed to
              protect the rights and property of Company and others and to
          ...
          <p>
            ...
            to inform you of any changes. Modifications to this Agreement shall
          ...
          <p>
            If there is a dispute between users of the Website, or between users
          ...
          <p>
            All questions of law, rights, and remedies regarding any act, event
            or occurrence undertaken pursuant or relating to this Website or the
            Company Services shall be governed and construed by the laws of the
            State/Commonwealth of Oklahoma, excluding such state’s conflicts of
            ...
            federal or state courts located in or with jurisdiction over Tulsa
            County, State of Oklahoma; subject, however, to the right of
            Company, at the Company's sole discretion, to bring an action to
            seek injunctive relief to enforce this Agreement or to stop or
            prevent an infringement of proprietary or other third party rights
            (or any similar cause of action) in any applicable court in any
            jurisdiction where jurisdiction exists with regard to a user. You
            hereby consent to (and waive any challenge or objection to) personal
            jurisdiction and venue in the above-referenced courts. Application
            ...
            claim, action or proceeding by you related in any way to the Website
            and/or the Company Services (including your visit to or use of the
            Website and/or the Company Services) be instituted more than two (2)
            years after the cause of action arose. You will be liable for any
            attorneys' fees and costs if we have to take any legal action to
          ...
          <p>
            ...
            the Website. By operating the Website, Company does not represent or
            imply that Company endorses any blogs, contributions or other
            content available on or linked to by the Website, including without
            ...
            objectionable content you may encounter on the Website or in
            ...
            Website or Company Services.
          </p>
          <p>
            YOU AGREE THAT YOUR USE OF THE WEBSITE AND COMPANY SERVICES WILL BE
            AT YOUR SOLE RISK. TO THE FULLEST EXTENT PERMITTED BY LAW, COMPANY,
            ITS OFFICERS, DIRECTORS, EMPLOYEES, AND AGENTS DISCLAIM ALL
            WARRANTIES, EXPRESS OR IMPLIED, IN CONNECTION WITH THE WEBSITE AND
            THE COMPANY SERVICES AND YOUR USE THEREOF, INCLUDING, WITHOUT
            LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A
            PARTICULAR PURPOSE AND NON-INFRINGEMENT. COMPANY MAKES NO WARRANTIES
            OR REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF THE
            WEBSITE’S CONTENT OR THE CONTENT OF ANY WEBSITES LINKED TO THIS
          ...
          <p>
            ...
            Website for the purpose of the performance of the Company Services,
            as well as data relating to your use of the Company Services.
            Although we perform regular routine backups of data, you are
            primarily responsible for all data that you have transferred or that
            relates to any activity you have undertaken using the Company
            Services. You agree that Company shall have no liability to you for
            any loss or corruption of any such data, and you hereby waive any
            right of action against Company arising from any such loss or
          ...
          <p>
            ...
            a result of this Agreement or use of the Website and Company
            Services. Upon Company’s request, you will furnish Company any
