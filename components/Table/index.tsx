...
import { TableBody, TableHead, TableCell, TableFooter, TablePagination, Table as MTable, TableRow, withStyles } from '@material-ui/core';
                    ...
                    <div
                      ...
                      {el.sort === true ? (
                        <ReactSVG
                          ...
                          className={classNames(classes.icon, sort === ind? classes.selIcon:'')}
