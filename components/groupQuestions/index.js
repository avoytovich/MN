...
export default class Questions extends Component {
  ...
  render() {
            ...
            InputProps={{
              endAdornment: isActive ? (
                <InputAdornment variant="filled" position="end">
                  ...
                  {isAnswered ? (
                    <IconButton onClick={() => this.delete(index, questionId)}>
                      <Trash />
                    </IconButton>
                  ) : (
                    <IconButton onClick={() => this.skip(index)}>
                      <Redo />
                    </IconButton>
                  )}
                </InputAdornment>
                ...
                <InputAdornment variant="filled" position="end">
                  <IconButton
                    onClick={() =>
                      this.save(type, index, questionId, isAnswered)
                    }>
                    <Save />
                  </IconButton>
                </InputAdornment>
    ...
    return (
      <Fragment>
        <Grid
          className="group-questions-wrapper"
          container
          direction="column"
          wrap="wrap">
          <div className="group-questions-container">
            <Typography className="group-questions-title">
              New Questions
            </Typography>
