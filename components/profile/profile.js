...
export default class Profile extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      prevProps.values.imageContentId == 0 &&
      errors.imageContentId != prevProps.errors.imageContentId &&
          ...
          <Paper className="profile-modal-wrapper">
           ...
           <p className="profile-modal-description">To crop this image,drag the region below and click “Save”</p>
            ...
            <div className="profile-modal-btns-container">
              <Button
                className="profile-modal-btn profile-modal-btn-back"
            ...
            <Form>
              <Grid container>
                <Grid container justify="center">
                  <img
                    src={
                      imageContent ? imageContent.mediumImage : DefaultAvatar
                    }
                  ...
                  <Grid>
                    <Grid container direction="column">
                      ...
                      <h4
                        onClick={this.handleChangeImgage}
                        className="profile-action">
                        <img
                          src={EditIcon}
                          className="profile-action-img profile-action-edit-img"
                        />
                      ...
                      {imageContent && (
                        <h4
                          ...
                          <img
                            src={RemoveIcon}
                            className="profile-action-img profile-action-remove-img"
                          />
                          Remove
                        </h4>
                      )}
                    ...
                    <Grid container direction="column">
                      ...
                      <div className="profile-genders-container">
                        <p
                          ...
                          style={{
                            opacity: values.gender === 'Male' ? '1' : '0.5'
                          }}>
                          <img src={MaleIcon} />
                          Male
                        </p>
                        <p
                          ...
                          style={{
                            opacity: values.gender === 'Female' ? '1' : '0.5'
                          }}>
                          <img src={FemaleIcon} />
                          Female
                        </p>
